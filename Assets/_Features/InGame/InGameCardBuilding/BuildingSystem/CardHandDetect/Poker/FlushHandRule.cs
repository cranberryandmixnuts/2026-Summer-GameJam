...
public sealed class FlushHandRule : CardHandRule
{
    ...
    private const string YahtzeeId = "poker.yahtzee";
    ...
    private const int YahtzeePriority = 404;
    ...
    private static readonly int[] YahtzeeRankCounts = { 5 };
    ...
    public float YahtzeeBonus => _yahtzeeBonus;
    ...
    )
    {
        ...
        if (PokerHandEvaluator.CanMatchRankCounts(profiles, YahtzeeRankCounts))
        {
            AddMatch(
                YahtzeeId,
                "야추",
